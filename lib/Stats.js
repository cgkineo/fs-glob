...
class Stats extends ASyncIterator {
    ...
    copy(to, options) {
        ...
        return cloned.each(function copyNext(item, next, resolve) {
    ...
    collate(on, to, options) {
        ...
        return cloned.each(function collateNext(item, next, resolve) {
    ...
    delete() {
        ...
        return cloned.reverseEach(function deletesNext(item, next, resolve) {
