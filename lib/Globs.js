...
class Globs extends Array {
    ...
    constructor(globs, location, pwd) {
        ...
        var options = util.parseArguments(arguments, ["globs", "location", "pwd"], [["object", "undefined", "undefined"], ["array|string", "undefined|string", "undefined|string"]]);
    ...
    stats(options) {
        ...
        var options = util.parseArguments(arguments, ["options"], [["undefined|object"]]);
        ...
        return stack.each(function stackNext(item, next, resolve) {
    ...
    move(to, options) {
        ...
        var options = util.parseArguments(arguments, ["to", "options"], [["undefined|object"], ["undefined|string", "object"]]);
        options = util.defaults(options, {
            overwriteOlder: true,
            overwriteSame: false,
        ...
        return this.stats(options).then(function moveWalked(stats) {

            return stats.move(options);
    ...
    collate(on, to, options) {
        ...
        var options = util.parseArguments(arguments, ["on", "to", "options"], [["undefined|object"], ["undefined|string", "undefined|string", "object"]]);
        options = util.defaults(options, {
            overwriteOlder: true,
            overwriteSame: false,
            overwriteNewer: false,
        ...
        if (!options.on) {
            throw "Globs.collate: no 'on' argument defined";
        }
    ...
    watch(callback, options) {
        ...
        options = util.parseArguments(arguments, ["callback", "options"], [["object"], ["function", "undefined|object"]], "Globs.watch");

        if (arguments.length < 1) {
            throw "Globs.watch: requires at least one argument";
        }
        
        this.watches = this.watches || new ASyncIterator();

        for (var i = 0, l = this.watches.length; i < l; i++) {
            if (this.watches[i].options.callback === callback) {
